...
// req.params => info de un producto en particular por ej: un id. Es específica
...
app.get("/productos/:idProductos", (req, res) => {
  // el get es lo que va a recibir el servido
	// los : indica que lo que se recibe va a ser dinámico
	console.log(req.params);
	res.send("Hola con productos");
});
